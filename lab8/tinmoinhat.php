...
try {
    $sql = "SELECT idTin, TieuDe,TomTat,Ngay,urlHinh FROM tin WHERE lang='vi' ORDER BY Ngay DESC LIMIT 0,12";
    $kq = $conn->query($sql);
} catch (Exception $e) {
...
<div id="tinmoinhat" class="data ">
    <?php foreach ($kq as $tin) { ?>
        <div class="col">
            <h4> <a href="index.php?page=tin&tinchitiet.php&idTin=<?php echo $tin['idTin'] ?>"><?php echo $tin['TieuDe'] ?> </a> </h4>
