...
<table border="1px" width="100%" style="border-collapse:collapse">
    ...
    ?>
    <form method="POST" action="../admin/module/quanlysanpham/xuly.php?idsanpham=<?php echo $row['id_sanpham']?>" enctype="multipart/form-data">
        <tr>
            <td>Tên sản phẩm</td>
        ...
        <tr>
            ...
            <td>
                ...
                <img src="../admin/module/quanlysanpham/uploads/<?php echo $row['hinhanh']?>" width="200px" height="200px">
            </td>
            ...
            <td>
                <select name="tinhtrang">
                    <?php 
                        if($row['tinhtrang'] == 1){
                    ?>
                    <option value="1" select>Kích hoạt</option>
