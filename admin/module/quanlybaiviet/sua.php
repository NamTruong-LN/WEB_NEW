...
<table border="1px" width="100%" style="border-collapse:collapse">
    ...
    ?>
    <form method="POST" action="../admin/module/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id']?>" enctype="multipart/form-data">
        <tr>
            <td>Tên bài viết</td>
        ...
        <tr>
            ...
            <td>
                ...
                <img src="../admin/module/quanlybaiviet/uploads/<?php echo $row['hinhanh']?>" width="200px" height="200px">
            </td>
